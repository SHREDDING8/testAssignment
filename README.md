...
- [x] Авторизация с помощью Google Sign In
- [x] Acitivity indicator на белом фоне, во время загрузки всех данных
- [x] Установка и смена фотографии пользователя (сохряняется в базе данных и не пропадает во время перезапуска приложения)
- [x] Выпадающий список при поиске товаров
- [x] страница Page2 (страница конкретного товара)
...
<div style="display:flex;">
  <img src="https://user-images.githubusercontent.com/88378430/228386372-6ec40b0e-28d6-49f8-9388-b1cab196e64f.png" width="200">
</div>
